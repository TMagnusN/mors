...
目前已加入 TT raw static-eval cache、保守的 non-PV reverse futility pruning、
butterfly quiet history ordering、main-search quiet late-move pruning，以及
Reckless-style qsearch threshold SEE 與 noisy late-move pruning；
仍刻意不包含 killers/continuation history、NMP、forward futility、main-search LMR、singular
