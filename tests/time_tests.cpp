...
bool run_time_tests() {
    auto white = mors::Position::from_fen(mors::START_FEN);
    auto black = mors::Position::from_fen(
    ...
    mors::timeman::TimeManager manager;
    ...
    mors::SearchLimits black_limits;
    ...
    mors::timeman::GoParams zero_clock;
